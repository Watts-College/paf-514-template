...
### ANNOTATED PACKAGE CREATION SCRIPT
...
[ANNOTATED PACKAGE CREATION SCRIPT (right-click and save)](https://raw.githubusercontent.com/Watts-College/paf-514-template/main/labs/annotated-pkg-creation.R)
...
[DOWNLOAD THE TEMPLATE: monty-hall-pkg.R](https://www.dropbox.com/s/u8k1co2bb7eldzj/monty-hall-pkg.R?dl=1)
...
_Note, you should NOT be using RMD files in this assignment. The only files in the R folder should be R scripts with the functions needed for the package and complete roxygen fields. This script becomes the library of functions inside of your new package and the roxygen fields are converted into formal documentation for the package._ 
...
#### Where you will likely go wrong
...
Provide documentation for the functions in your package by adding [roxygen comments](https://rverse-tutorials.github.io/RWorkflow-NWFSC-2020/week5-roxygen.html) to your R scripts. The template script provided in Step 1.1 above includes complete roxygen comments for one function and some placeholder tags for the others. 
...
10. Transfer all of the files **inside** of your old "montyhall" folder into the new GitHub version. 
...
_**Do NOT** copy the full folder. **ONLY** copy the package files inside the folder._
