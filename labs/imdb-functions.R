...
# get_bio( bio.url ) %>% shorten_bio()



add_bios <- function( df ) {
  df$bio       <- purrr::map_chr( df$link, get_bio )  
  df$bio.short <- purrr::map_chr( df$bio, shorten_bio )
  return( df )
}
...
pander::pander(head(df2,3))


# --------------------------------------------------------------
#   names                           links                  
# -------------------- -----------------------------------------
#   Attila Dobai      https://www.imdb.com/name/nm8581180/bio 
# 
# Charlie Hiscock     https://www.imdb.com/name/nm4193460/bio 
# 
# Christopher Abbott   https://www.imdb.com/name/nm3571592/bio 
# --------------------------------------------------------------
#   
...
#   img                                                                           
# --------------------------------------------------------------------------------------------------------------------------------------------------------
#   https://m.media-amazon.com/images/M/MV5BZmQ3N2FkMDItN2Y4Ny00ZTJkLTk3NjQtNjFlMzlhMTMxMTVkXkEyXkFqcGdeQXVyMTcwODcxNjQw._V1_QL75_UX140_CR0,0,140,140_.jpg 
# 
...
#   bio                           bio.short            
# -------------------------------- --------------------------------
#   Attila Dobai is known for Poor   Attila Dobai is known for Poor 
# Things (2023), Holnap tali!      Things (2023), Holnap tali!   
#   (2016) and Most vagy soha!       (2016) and Most vagy soha!   
#   (2024).                          (2024).             
# 
# Charlie J. Hiscock can be seen   Charlie J. Hiscock can be seen 
# as "Will" on the Emmy award      as "Will" on the Emmy award   
# winning Apple+ series "Ted       winning Apple+ series "Ted   
# Lasso," which was made history   Lasso," which was made history 
# with its 20 Emmy nominations     with its 20 Emmy nominations  
# for a comedy series. Hiscock     for a comedy series. Hiscock  
# is also known for his work on    is also known for his work on  
# the BAFTA winning and Emmy       the BAFTA winning and Emmy   
# nominated series "Secret Life    nominated series "Secret Life  
# of Boys." He began his career    of Boys." He began his career  
# at the young age of 9 and made   at the young age of 9 and made 
# his professional debut on the    his professional debut on the  
# British TV series "Combat        British TV series "Combat    
# Kids." He then followed that     Kids." He then followed that  
# up with the BBC TV movie         up with the BBC TV movie    
# adaptation of "The Borrowers"    adaptation of "The Borrowers"  
# opposite Christopher             opposite Christopher      
# Eccleston, Sharon Horgan and     Eccleston, Sharon Horgan and  
# Stephen Fry. Hiscock then took            Stephen Fry.          
# a break to focus on school and                                  
# then got back into the                                      
# business in 2018 with "Secret                                   
#    Life of Boys." - IMDb Mini                                    
# Biography By: Mia Hansen                                     
# 
# Christopher Jacob Abbott is an   Christopher Jacob Abbott is an 
# American actor. Abbott made      American actor. Abbott made   
# his feature film debut in        his feature film debut in    
# Martha Marcy May Marlene         Martha Marcy May Marlene    
# (2011). Abbott's other notable   (2011). Abbott's other notable 
# films include Hello I Must Be    films include Hello I Must Be  
# Going (2012) and The             Going (2012) and The      
# Sleepwalker (2014). In 2015,     Sleepwalker (2014). In 2015,  
# Abbott starred as the titular    Abbott starred as the titular  
# character in the critically      character in the critically   
# acclaimed film James White. In   acclaimed film James White. In 
# 2017, he starred opposite Joel   2017, he starred opposite Joel 
# Edgerton in the psychological    Edgerton in the psychological  
# horror film It Comes at Night.   horror film It Comes at Night. 
# In 2018, he portrayed                                       
# astronaut David Scott in the                                   
# film First Man, and a reporter                                  
# in Vox Lux. Abbott portrayed                                   
# John Yossarian as the lead                                    
# role in the 2019 miniseries                                    
# Catch-22 based on the Joseph                                   
# Heller novel of the same name,                                  
# for which he was nominated for                                  
# the Golden Globe Award for                                    
# Best Actor - Miniseries or                                    
# Television Film. In 2020, he                                   
# co-starred in the films Black                                   
# Bear, Possessor and The World                                   
# to Come. - IMDb Mini Biography                                  
# By: Bonitao                                            
# -----------------------------------------------------------------
#   
...
df2 <- 
structure(list(names = c("Attila Dobai", "Charlie Hiscock", "Christopher Abbott", 
"Emma Hindle", "Emma Stone", "Hanna Schygulla", "Jack Barton", 
"Jerrod Carmichael", "Kathryn Hunter", "Mark Ruffalo", "Ramy Youssef", 
"Suzy Bemba", "Vicki Pepperdine", "Willem Dafoe"), links = c("https://www.imdb.com/name/nm8581180/bio", 
...
"Emma Hindle is known for Poor Things (2023), Harvest and Grantchester (2014).", 
...
"Jack Barton is known for Poor Things (2023), Chronic (2022) and War of the Worlds (2019).", 
...
"Suzy Bemba is known for Poor Things (2023), Kandisha (2020) and Drift (2023).", 
